package java.com.demo.mms.common.utils;
...
public class DateUtil {
    ...
    public static boolean validateIsDate(String strTime) {
        ...
        if (date != null) {
            System.out.println("生成的日期:" + com.demo.mms.common.utils.DateUtil.parseDateToStr(date, com.demo.mms.common.utils.DateUtil.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS, "--null--"));
            return true;
        }
        return false;
    }
    ...
    public static void main(String[] args) {
        try {
            com.demo.mms.common.utils.DateUtil dateUtil = new com.demo.mms.common.utils.DateUtil();
            System.out.println();
